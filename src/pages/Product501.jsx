...
// As per your latest code, imagesToShow always uses defaultImages
 ...
 <span className="block">🔹 <strong>Weight:</strong>35 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>36</span>
</p> 
...
const MobileProductDetailContent = () => {
 ...
 <span className="block">🔹 <strong>Weight:</strong>35 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>36</span></p>
      </div>
