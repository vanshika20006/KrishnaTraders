...
const Productcardfinal = () => {
    ...
    <Navbar />
      ...
      <div className="bg-[#112D4E] w-screen py-10 px-10 flex justify-between text-white">
        ...
        <div className=" ml-30 w-[45%] flex flex-col items-start">
          <div className="product-image-slider w-[500px] h-[450px] bg-white rounded-md overflow-hidden flex items-center justify-center">
            <SimpleImageSlider
              width={600}
              height={480}
              images={imagesToShow}
 ...
 <h4 className="text-[18px] pt-1">{size || "Product Size"}</h4>
           ...
           <p className="text-gray-300 text-[15px] font-light pt-5 leading-relaxed">
            <span className="block">🔹 <strong>Weight:</strong>-</span>
            <span className="block">🔹 <strong>Packaging:</strong>SINGLE BOX (10PCS BOX)</span>
          </p>
