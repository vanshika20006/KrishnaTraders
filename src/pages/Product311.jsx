...
const defaultImages = [
  { url: "CRYSTALSHORTBODY.jpg" },
  { url: "CRYSTALSHORTBODY2.jpg" },
  { url: "EVERYSHORTLONG.jpg" },
];
...
<span className="block">🔹 <strong>Weight:</strong>98 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>12</span>   </p> 
...
<span className="block">🔹 <strong>Weight:</strong>98 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>12</span>  
</p>
      </div>
