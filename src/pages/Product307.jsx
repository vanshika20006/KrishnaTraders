...
const defaultImages = [
 ...
 <span className="block">🔹 <strong>Weight:</strong>150 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>1 (single box)</span>   </p> 
...
<span className="block">🔹 <strong>Weight:</strong>150 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>1 (single box)</span>          
</p>
      </div>
