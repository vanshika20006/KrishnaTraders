...
const defaultImages = [
    { url: "DOUBLEBOWL1F.jpg" },
    { url: "DOUBLEBOWL1F2.jpg" },
    { url: "DOUBLEBOWL1F3.jpg" },
      ...
      <div className="bg-[#112D4E] w-screen py-10 px-10 flex justify-between text-white">
        ...
        <div className="w-[25%] mr-80 flex flex-col">
          ...
          <p className="text-gray-300 text-[15px] font-light pt-5 leading-relaxed">
            ...
            <span className="block">🔹 <strong>Color:</strong> White / Black</span>
            <span className="block">🔹 <strong>Packaging:</strong>2-10PCS MASTER BOX</span>
                  </p> 
