...
// As per your latest code, imagesToShow always uses defaultImages
  ...
  return (
    <>
      ...
      <span className="block">🔹 <strong>Weight:</strong>45 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>100</span>
</p> 
...
const MobileProductDetailContent = () => {
  ...
  return (
    <div className="bg-[#112D4E] w-full min-h-screen py-6 px-4 flex flex-col text-white">
      ...
      <span className="block">🔹 <strong>Weight:</strong>45 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>100</span></p>
      </div>
