...
const DesktopProductDetailContent = () => {
  ...
  const defaultImages = [
    { url: "/Aqua12X12.jpg" }, // Adjusted path assuming images are in public folder
    { url: "/Aqua24X24.jpg" }, // Adjusted path
    { url: "/AquaBack.jpg" },  // Adjusted path
  ];
      ...
      <div className="bg-[#112D4E] w-screen py-10 px-10 flex justify-between text-white">
        ...
        <div className="w-[25%] mr-80 flex flex-col">
          ...
          <p className="text-gray-300 text-[15px] font-light pt-5 leading-relaxed">
            <span className="block">🔹 <strong>Weight:</strong> 3.600KG</span>
...
const MobileProductDetailContent = () => {
  ...
  const defaultImages = [
    { url: "/Aqua12X12.jpg" }, // Adjusted path
    { url: "/Aqua24X24.jpg" }, // Adjusted path
    { url: "/AquaBack.jpg" },  // Adjusted path
  ];
