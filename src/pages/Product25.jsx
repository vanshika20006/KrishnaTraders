...
<span className="block">🔹 <strong>Weight:</strong>3.500KG</span>
            <span className="block">🔹 <strong>Color:</strong> White / Grey</span>
            <span className="block">🔹 <strong>Packaging:</strong>10</span>          </p> 
...
const MobileProductDetailContent = () => {
  ...
  return (
    <div className="bg-[#112D4E] w-full min-h-screen py-6 px-4 flex flex-col text-white">
     ...
     <span className="block">🔹 <strong>Weight:</strong>3.500KG</span>
            <span className="block">🔹 <strong>Color:</strong> White / Grey</span>
            <span className="block">🔹 <strong>Packaging:</strong>10</span>
        </p>
      </div>
