...
const DesktopProductDetailContent = () => {
 ...
 const defaultImages = [
  ...
  return (
   ...
   <span className="block">🔹 <strong>Weight:</strong>81 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>12 (single box)</span></p> 
...
const MobileProductDetailContent = () => {
 ...
 const defaultImages = [
  ...
  return (
   ...
   <span className="block">🔹 <strong>Weight:</strong>81 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>12 (single box)</span>
</p>
      </div>
