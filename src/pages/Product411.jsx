...
const defaultImages = [
    { url: "DIVERTOR-WITH-PLATE-1st.jpg" },
    { url: "Divertor-2nd.jpg" },
    { url: "Divertor-3.jpg" },
  ];
// As per your latest code, imagesToShow always uses defaultImages
  ...
  <span className="block">🔹 <strong>Weight:</strong>740 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>1</span>
</p> 
...
const defaultImages = [
 ...
 <span className="block">🔹 <strong>Weight:</strong>740 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>1</span></p>
      </div>
