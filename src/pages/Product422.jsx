...
const defaultImages = [
    { url: "Long-body-JERRY-1st.jpg" },
    { url: "Long-body-JERRY.jpg" },
...
<span className="block">🔹 <strong>Weight:</strong>255 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>4</span>
</p> 
...
<span className="block">🔹 <strong>Weight:</strong>255 GM</span>
            <span className="block">🔹 <strong>Packaging:</strong>4</span></p>
      </div>
