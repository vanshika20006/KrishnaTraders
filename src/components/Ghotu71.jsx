...
const products = [
 {
    ...
    inStock: true,
    size: 36, // in inches
    image: "/Sidehandle1.jpg",
  },
    {
    id: 2,
    name: "SINGLE TOP PUSH BUTTON",
    price: 5000,
    inStock: true,
    size: 42, // in inches
    ...
    {
    id: 4,
    name: "ULTRA SLIM BODY",
    price: 4500,
    inStock: true,
    size: 36, // in inches
    image: "/Singletoppushbutton1.jpg",
  },
    {
    id: 5,
    name: "SINGLE FRONT PUSH ",
    price: 5000,
    inStock: true,
    size: 42, // in inches
