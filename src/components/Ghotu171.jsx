...
// --- ProductCard Component (with price, discountedPrice, and size display) ---
  ...
  return (
    ...
    >
      ...
      <div className="bg-white p-3 md:p-4 text-center"> {/* Responsive padding */}
        ...
        {/* Color dots - these are static for now, consider dynamic rendering if needed */}
...
const categories = [
  ...
  { image: "THREADBALL.jpg", label: "UPVC BALL VALVE", route: "/varients171" },
  { image: "HEAVYCPVCBALL.jpg", label: "CPVC BALL VALVE", route: "/varients172" }
...
const DesktopGhotu = () => {
  ...
  return (
    // This entire div for DesktopGhotu is the exact code you provided previously
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#f9f9e6] overflow-x-hidden p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <h2 className="text-xl font-semibold text-[#1a1f2c]">UPVC BALL VALVE</h2>
