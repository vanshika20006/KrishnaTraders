...
const categories = [
  ...
  { image: "FRP36X36.jpg", label: "LOCK PATTERN (CAPITAL)", route: "/size22" },
  { image: "Aqua18X18.jpg", label: "PVC CLASSIC (CAPITAL)", route: "/size21" },
  { image: "FRP36X36.jpg", label: "EXTRA HEAVY (1T)", route: "/size23" },
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#f9f9e6] overflow-x-hidden p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-[#1a1f2c]">Lock Pattern (Capital)</h2>
