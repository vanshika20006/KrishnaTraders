...
import ProductCard from "./ProductCardQuards";
...
const categories = [
  ...
  { image: "FRP18X36.jpg", label: "QUARDS SINK", route: "/varients11" },
  { image: "LOCK18X24.jpg", label: "STEEL SINK", route: "/varients12" }
  ...
  return (
    <div className="flex gap-x-6 w-full h-screen bg-[#f9f9e6] overflow-hidden px-6">
      ...
      <div className="flex-1 px-2 py-6">
        ...
        >
          <h2 className="text-2xl font-semibold text-[#1a1f2c]">QUARDS SINK</h2>
