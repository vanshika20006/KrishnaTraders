...
const products = [
  ...
  },
  {
    ...
    inStock: true,
    size: "18X18",
    image: "/Mixer-with-bend-JERRY-1st.jpg",
  }
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#f9f9e6] overflow-x-hidden p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-[#1a1f2c]">JERRY MODEL</h2>
