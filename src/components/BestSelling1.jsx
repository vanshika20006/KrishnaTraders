...
const products = [
  {
    id: 1,
    name: "FRP CHAMBER COVER",
    price: "", // Price is still in data but not displayed
    inStock: true,
    image: "/frpfront.jpg",
  },
  {
  ...
  return (
    <div className="flex gap-x-6 w-full h-screen bg-[#f9f9e6] overflow-hidden px-6">
      ...
      <div className="flex-1 px-2 py-6">
        ...
        >
          <h2 className="text-2xl font-semibold text-[#1a1f2c]">Chamber Cover</h2>
