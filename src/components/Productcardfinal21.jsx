...
const ClassicProductCard = () => {
  const [current, setCurrent] = useState(0);
  const length = classicImages.length;
  ...
  return (
    <div className="bg-[#112D4E] w-screen py-10 flex justify-evenly text-white">
      ...
      <div className="w-[25%] flex flex-col">
        <h4 className="text-[19px]">CLASSIC Series</h4>
        <p className="text-gray-300 text-[16px] font-light pt-5">Elegant and durable, ideal for regular usage environments.</p>
        <h3 className="pt-9 mb-10">M.R.P.: ₹3499.00</h3>
